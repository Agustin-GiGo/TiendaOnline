    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item px-lg-4">
          <a class="nav-link text-uppercase text-expanded" href="usuariosS">Configuracion de Usuarios</a>
        </li>
       
            
         <li class="nav-item px-lg-4">
          <a class="nav-link text-uppercase text-expanded"href="revision">Revision de Productos</a>
          </li>
               ...
               <div class="col-xl-9 mx-auto">
                 <div class="cta-inner text-center rounded">
                   <h2 class="section-heading mb-4">
                     <span class="section-heading-upper">Cromiso total</span>
